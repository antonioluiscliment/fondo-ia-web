...
// Marca un error como "datos insuficientes" (índice demasiado
// pequeño, no hay suficientes candidatos válidos) en vez de un fallo
// real (red, Yahoo caído...). El llamante lo distingue con
// error.insuficiente, para mostrarlo como aviso informativo en vez de
// como error.
export function errorInsuficiente(mensaje) {
