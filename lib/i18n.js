...
export const T = {
  es: {
    ...
    rentabilidadEtfsDesc: "Compara la rentabilidad del índice con la de sus ETFs UCITS de distribución de referencia (no de acumulación: el índice se calcula con cotizaciones ex-dividendo, y solo un ETF de distribución es comparable en esos términos). En verde, los periodos en los que el ETF supera al índice; en rojo, los que quedan por debajo.",
  ...
  en: {
    ...
    rentabilidadEtfsDesc: "Compares the index's return with that of its reference distributing UCITS ETFs (not accumulating: the index is computed from ex-dividend prices, and only a distributing ETF is comparable on those terms). Green marks periods where the ETF beats the index; red marks periods where it falls short.",
