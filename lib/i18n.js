...
export const T = {
  es: {
    ...
    indiceFijoNota: "El índice de referencia usado en toda la aplicación es, por ahora, fijo: el Dow Jones.",
  ...
  en: {
    ...
    indiceFijoNota: "The benchmark index used throughout the app is, for now, fixed: the Dow Jones.",
