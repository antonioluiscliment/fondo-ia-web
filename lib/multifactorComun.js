...
//
// Base matemática de "Selección por modelo multifactor": la regresión
// ridge que ajusta los pesos de las variables (las operaciones
// matriciales que usa viven en lib/algebraComun.js, compartidas con
// "Modelo de réplica de un índice").
//
