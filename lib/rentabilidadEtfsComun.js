...
// Rentabilidad entre "actual" y una referencia pasada, o null si
// alguno de los dos precios falta o el de referencia es cero.
function rentabilidadDesde(actual, referencia) {
  if (!referencia || referencia.cierre === null || referencia.cierre === undefined || referencia.cierre === 0) return null;
  if (actual === null || actual === undefined) return null;
  return Number(((actual / referencia.cierre - 1) * 100).toFixed(2));
}
...
function calcularRentabilidades(cierres) {
  ...
  return {
    ...
    anio1: rentabilidadDesde(actual, ref1a),
    anio2: rentabilidadDesde(actual, ref2a),
    anio3: rentabilidadDesde(actual, ref3a),
  };
}
